...
###litbound vs. pragbound###
    ...
    axs[1,0].scatter(rep_attr,np.ones(len(rep_attr)),s=80,color='black')
    axs[1,0].scatter(rep_no_attr,np.ones(len(rep_no_attr)), s=80, color='white',edgecolor='black')
