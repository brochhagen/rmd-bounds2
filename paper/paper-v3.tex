...
\paragraph{Lexica, types, and transmission bias.} We consider a state space with three states $\States = \set{\snone, \ssome, \sall}$. This space can be
...
based on their truth or falsity in three world states, six of which are not contradictory
 or tautologous. These are listed with mnemonic names in
...
Recall that types are a combination of a lexicon and a manner of language use: literal or pragmatic. Accordingly, there are $432$ types in this model. \hl{Here. Add footnote on redundancy and results holding for smaller spaces with $40$ types or the original $12$ from Br}


In our setup, pragmatic $\Llack$-style speakers have a functional disadvantage over $\Lbound$-style ones as 


\tb{Many of these assign the same concept to
