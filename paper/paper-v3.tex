...
languages. Models of language evolution abound. There are simulation-based models studying
...
one-to-one mapping of messages to states. Finally, lexically that do not lexicalize an upper
...
type's arguably central communicative function of transferring information to peers. Acquiring
a maximally expressive type is of little use when it fails to be understood in its population.
...
their potential expressive deficiencies. Hence model of co-evolving semantics and pragmatics is
...
learnability might come in again. The present work made a first start and gave a framework for
