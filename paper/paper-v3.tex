...
showcased in Figure \ref{fig:only-R}, which shows the proportion of target types, pragmatic competitor types and pragmatic $\Lall$ in a representative population after $50$ replicator steps. The plot also indicates the proportion of the
...
\caption{Proportion of target types, pragmatic competitor types, pragmatic $\Lall$, and population's majority type in representative populations after $50$ generations under only a
