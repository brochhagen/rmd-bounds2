...
\begin{figure}[h!]
  \centering
  \includegraphics[scale=.45]{../code-LOT-extension/plots/priors-meFalse432.png} %width = 0.75\linewidth
...
\begin{figure}[h!]
  \centering
  \includegraphics[scale=.45]{../code-LOT-extension/plots/priors-binned-meFalse432.png} %width = 0.75\linewidth
...
\begin{figure}[h!]
  \centering
  \includegraphics[scale=.4]{../code-LOT-extension/plots/r-lam30-a1-k15-s200-l10-meFalse432-nomean.png} %width = 0.75\linewidth
