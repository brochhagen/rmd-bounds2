...
\centering
   ...
   \path[->, thick, densely dashdotted, Steelblue] (4.25,4.25) edge [bend left] node[sloped,above] {\footnotesize learning\textsubscript{flat}} (2.75,2.75);
     ...
     \draw[->, thick, goldish] (0.75,5.25) -- (2.25,5.25) node[midway, above] {\footnotesize learning\textsubscript{biased}};
     \draw[<-, thick, goldish] (2.75,5.25) -- (4.25,5.25) node[midway, above] {\footnotesize learning\textsubscript{biased}};
...
\begin{figure}[t]
\centering
\includegraphics[width=1\textwidth,height=10cm,keepaspectratio]{./plots/fig6} %alternatively without '-3d'
