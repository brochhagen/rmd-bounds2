...
f1 = csv.reader(open('./results/3multiscalar-unwgh-mean-a1-c0.100000-l30-k50-g30-r100.csv','rt'))
f2 = csv.reader(open('./results/3multiscalar-wgh-mean-a1-c0.100000-l30-k50-g30-r100.csv','rt'))
...
ax.set_title('3 scalars (alternative3). a = %r, c = %r, lam = %r, k = %r' % (1, .1, 30, 50))
